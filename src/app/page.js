...
export default function Home() {
  ...
  const handleClaim = (e) => {
    ...
    const cleanUsername = username
      .replace("https://zookly.vercel.app/", "")
      .trim();
    ...
    <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-blue-100 overflow-x-hidden">
        ...
        <section className="pt-32 pb-20 px-4 max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="flex-1 text-center md:text-left z-10">
            ...
            <p className="text-lg text-slate-500 mb-10 max-w-xl mx-auto md:mx-0 leading-relaxed">
              Creators like you using Zookly. One link to help you share
              everything you create, curate, and sell.
            </p>

            <form
              onSubmit={handleClaim}
              className="flex flex-col sm:flex-row items-center gap-4 w-full max-w-lg mx-auto md:mx-0 mb-12"
            >
      ...
      <footer className="py-12 text-center bg-white border-t border-slate-100">
        <p className="text-slate-500 text-sm font-medium">
          © 2026 Zookly. All rights reserved.
        </p>
      </footer>
    </div>
  );
